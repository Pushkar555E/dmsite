...
function footer() {
  return `<footer class="footer">
    <div class="container footer-grid">
      ...
      <div><h2>Pages</h2><a href="pricing.html">Pricing</a><a href="portfolio.html">Portfolio</a><a href="blog.html">Blog</a><a href="contact.html">Contact</a><a href="privacy.html">Privacy Policy</a><a href="terms.html">Terms</a><a href="refund.html">Refund Policy</a></div>
...
const home = layout({
  ...
  <section class="section-pad" id="case-studies"><div class="container featured-case-card"><div class="featured-case-copy"><span class="eyebrow">Featured Client Project</span><span class="case-status">Archived client work</span><h2>Growth Nest — archived digital agency website.</h2><p>Nexora Digital designed and developed a professional agency website for Growth Nest. The original live deployment is no longer publicly available, so verified project screenshots are preserved here as proof of the completed work.</p><div class="case-detail-row"><span><strong>Project type</strong>Client Website</span><span><strong>Status</strong>Archived</span><span><strong>Service</strong>Website Design &amp; Development</span></div><div class="case-actions"><a class="btn btn-primary" href="portfolio.html#case-studies">View Case Study</a><button class="btn btn-secondary" type="button" data-project-open="growth-nest">View Project Proof</button></div></div><div class="featured-case-media"><img src="/clients/growth-nest-proof.png" width="1600" height="900" loading="lazy" decoding="async" alt="Archived Growth Nest client website proof showing the Growth Nest digital marketing agency logo"></div></div></section>
